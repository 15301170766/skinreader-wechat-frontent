          ...
          <!--      <div id="status" style="font-size: 20px">
                ...
                <span style="">
                    <div style="text-align: left;
                        ...
                        <p style="font-size: 17px">以下为您绑定的个人信息</p>
                    </div>
                   <el-form :rules="rules" ref="form" :model="form" label-width="0px">
                    <el-form-item  prop="phone" style="height: 55px">
                            ...
                            <p class="form">
                                <el-input class="form_input" style="font-family: inherit" disabled v-model="form.phone" placeholder="请输入手机号"></el-input>
                            </p>
                    </el-form-item>
                        ...
                        <el-button :disabled="disable" v-loading="loading" type="button" value="绑定" class="btn" @click="Jump()">
                            {{subMsg}}
                        </el-button>
                        </el-form>
            ...
            async  hint() {
              ...
              console.log(res)
               ...
               if (resJson.openid){
                  ...
                  //  this.form.phone = findInfo.data.getPatientInfoByFwhOpenid.phone
                    this.$set(this.form,'phone',findInfo.data.getPatientInfoByFwhOpenid.phone)
