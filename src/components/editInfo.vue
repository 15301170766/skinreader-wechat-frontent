          ...
          <!--      <div id="status" style="font-size: 20px">
                ...
                <span style="">
                    <div style="text-align: left;
                        ...
                        <p style="font-size: 25px">修改绑定信息</p>
                    ...
                    <el-form-item  prop="phone" style="height: 55px">
                            <p class="form">
                                <el-input class="form_input" style="font-family: inherit" v-model="form.phone" placeholder="请输入手机号"></el-input>
                                     ...
                                     <el-form-item  prop="code" style="height: 55px">
                            <p class="form form2">
                                <el-input class="form_input" style="font-family: inherit" v-model="form.code" placeholder="请输入验证码"></el-input>
                                 <el-button v-if="isShowGetCode"  type="button" value="绑定" class="btn3" @click.prevent="getCode">
                                  获取验证码
                              </el-button>
                              <el-button  v-else  type="button" value="绑定" class="btn3" >
                                  {{timerNum}}s
                              </el-button>
                            </p>
                    </el-form-item>
                    <el-button :disabled="disable" v-loading="loading" type="button" value="绑定" class="btn" @click="login2('form')">
                            {{subMsg}}
                        </el-button>
                        </el-form>
      ...
      if (reg.test(this.form.phone)) {
        ...
        try {
          await this.$apollo.mutate({
            mutation: gql`mutation($phone: String!){
              sendVCode(phone: $phone)
            }`,
            variables: {
